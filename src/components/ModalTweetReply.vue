<template>
  <section class="modal-tweet-section">
    <button class="btn tweet-reply" @click.stop.prevent="openModal">
      <img class="tweet-reply-icon" src="./../assets/icon/tweet-reply1.svg" alt="" />
    </button>
      ...
      <div class="modal-container">
        ...
        <form class="modal-content">
          <router-link class="avatar" :to="{ name: 'user', params: { id: initialTweet.UserId } }">
            <img class="avatarImg" :src="initialTweet.User.avatar | emptyImage" alt="" />
          </router-link>

          <div class="twitter-reply-container">
            <router-link class="twitter-reply name" :to="{ name: 'user', params: { id: initialTweet.UserId } }">{{
            ...
            <router-link class="twitter-reply info" :to="{ name: 'user', params: { id: initialTweet.UserId } }">@{{
              ...
              }}</router-link>・<span class="twitter-reply info">{{ initialTweet.createdAt | fromNow }}</span>
          ...
          <button class="btn btn-post-reply-tweet" @click.stop.prevent="createdTweet(initialTweet.id)"
